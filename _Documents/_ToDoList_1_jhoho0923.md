...
- [x] 240507(수) 오늘 작업한 내용:  
  React 적용된 마지막 소스코드를 chatbot AI적용를 끝낸 부동산 데이터 조회 웹 서비스 페이지를 최종 업데이트 및 배포를 완료하였고(원빈씨가 약 80%이상 작업진행을 완료하였음.), 금일 오후 중 프로젝트 발각 팀들이 개발한 웹 사이트를 가지고 프로젝트 발표회를 진행할 예정입니다. 모두 고생 많으셨습니다.
